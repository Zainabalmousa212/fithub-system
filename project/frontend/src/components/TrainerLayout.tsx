...
import { LayoutDashboard, Users, Calendar, BarChart3, User, LogOut, Menu, X } from "lucide-react";
      ...
      <header className="sticky top-0 z-40 border-b border-border/50 bg-card/80 backdrop-blur-sm">
        <div className="container flex h-16 items-center justify-between px-4">
          <Link to="/trainer/dashboard" className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-muted-foreground hidden sm:inline">Trainer Portal</span>
          </Link>
